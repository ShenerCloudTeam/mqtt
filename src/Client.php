...
use ShenerCloud\Mqtt\Application\EmptyWritableResponse;
use ShenerCloud\Mqtt\Exceptions\NotConnected;
use ShenerCloud\Mqtt\Exceptions\ServerClosedConnection;
...
use ShenerCloud\Mqtt\Protocol\Disconnect;
...
final class Client extends ProtocolBase implements ClientInterface
{
     ...
     * @throws \ShenerCloud\Mqtt\Exceptions\NonMatchingPacketIdentifiers
